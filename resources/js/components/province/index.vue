...
<template>
    <page-index url="/admin/portal/province" prefix="list" name="Genre">
        <template slot="actions">
            <router-link to="/admin/province/create" class="btn btn-primary ml-2">New Province</router-link>
        </template>
        ...
        <template slot="table-row" slot-scope="data">
            ...
            <td>
                <router-link :to="`/admin/province/${data.row.id}/view`" class="action-icon text-primary">
