                                ...
                                <tr v-for="row in data.content.data">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center align-items-center">
                                            <router-link :to="`/library/albums/${row.id}/view`" class="cart__delete mr-3" type="button">
                                                <i class="mdi mdi-eye text-primary mdi-24px"></i>
                                            </router-link>
                                            <router-link :to="`/library/albums/${row.id}/edit`" class="cart__delete mr-3" type="button">
                                                <i class="mdi mdi-pencil text-white mdi-24px"></i>
                                            </router-link>
